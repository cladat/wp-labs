<div class="wrap">
    ...
    <?php wp_nonce_field('send-mail'); ?>
        <table class="form-table">
            <tr>
                <th>e-mail</th>
                <!-- Lorsqu'on affiche le formulaire sans être passé par les validations aucune clé old na été enregistré dans la sessions, ceci créer une erreur si l'on demande de l'afficher,c'est pour cela que l'on met une condition,on demande de l'afficher que si elle existe -->
