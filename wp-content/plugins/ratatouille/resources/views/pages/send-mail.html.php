<div class="wrap">
    ...
    <div class="row">
        ...
        <!-- on reçois la variable mails (celle qu'on a compact dans la commit précedent) c'est une variable qui contient un tableau contenant chaque mails enregistré dans la Base de donnée(bdd), on va donc faire un foreach et créer une div class postbox pour chaque élément afin d'avoir un rendu correct. -->
