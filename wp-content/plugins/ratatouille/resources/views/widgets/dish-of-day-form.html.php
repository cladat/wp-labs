<p>
    <label for="title"><?php esc_attr_e('Title:', 'text_domain'); ?></label>
     <!-- On utilise les variables title et text pour les afficher dans notre vue et pour cela on les mets dans value pour l'input et entre les balises pour textarea. -->
