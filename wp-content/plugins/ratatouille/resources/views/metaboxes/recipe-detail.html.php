  ...
  <tr>
    ...
    <td>
      <select name="rat_time_preparation" id="rat_time_preparation">
        <!-- Maintenant que le tableau à été traité et renvoyé dans cette vue on peut se servir de la clef devant laquelle on rajoute un "$" pour récupérer la valeur qui lui à été attribuée. -->
