...
function simplarity_autoloader($class_name)
{
  ...
  if (strpos($class_name, 'App') !== false) {
    ...
    // on modifie la syntaxe de la class name pour passer de "App\Features\PostTypes\RecipePostType" à "App/Features/PostTypes/RecipePostType.php" voila ce que fait la combinaison de la fonction strp_replace et de l'argument DIRECTORY_SEPARATOR 
    // http://php.net/manual/fr/function.str-replace.php
    // DIRECTORY_SEPARATOR générera "/" ou "\" selon le systeme d'exploitation de la machine 
