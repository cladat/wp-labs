...
class Mail
{
  // les propriétés de l'objet model. Les propriétés de l'objet qui sont représentatives de la structure de la table dans la base de donnée.
  ...
  // On créé une seconde function 'find()' pour faire une requête différente de 'all()' ,find elle ira récupérer dans la base de donnée que les mails dont l'id vaut ce qui est passé dans l'url.
  ...
  // Function qui va nous permettre de supprimer un mail dans la base de donné,cette function attend un paramètre '$id' que l'on va remplir par la suite quand on va appeler cette function
