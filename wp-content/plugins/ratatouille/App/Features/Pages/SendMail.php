...
class SendMail
{
  ...
  {
    // on va chercher toute les entrées de la table dont le model mail s'occupe et on inverse l'ordre afin d'avoir le plus récent en premier.
  ...
  public static function show()
  {
    ...
    $mail = Mail::find($id);
    // on retourne une vue avec le contenu de Mail, cette vue n'est pas encore crée nous allons la crée au prochain commit. Pour l'instant si vous cliquez il essaie d'affiche un fichier qu'il ne trouve pas et vous vous retrouvez donc avec un fond gris.
